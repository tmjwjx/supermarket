...
const (
	...
	ErrorReason_ORDER_STATUS_CONFLICT    ErrorReason = 3
	ErrorReason_ORDER_ITEM_NOT_SELLABLE  ErrorReason = 4
	ErrorReason_ORDER_STOCK_INSUFFICIENT ErrorReason = 5
	ErrorReason_ORDER_ADDRESS_NOT_FOUND  ErrorReason = 6
)
...
var (
	ErrorReason_name = map[int32]string{
		...
		3: "ORDER_STATUS_CONFLICT",
		4: "ORDER_ITEM_NOT_SELLABLE",
		5: "ORDER_STOCK_INSUFFICIENT",
		6: "ORDER_ADDRESS_NOT_FOUND",
	}
	ErrorReason_value = map[string]int32{
		"ORDER_UNSPECIFIED":        0,
		"ORDER_NOT_FOUND":          1,
		"ORDER_INVALID_ARGUMENT":   2,
		"ORDER_STATUS_CONFLICT":    3,
		"ORDER_ITEM_NOT_SELLABLE":  4,
		"ORDER_STOCK_INSUFFICIENT": 5,
		"ORDER_ADDRESS_NOT_FOUND":  6,
	}
)
...
const file_order_v1_error_reason_proto_rawDesc = "" +
	...
	"\x16ORDER_INVALID_ARGUMENT\x10\x02\x12\x19\n" +
	"\x15ORDER_STATUS_CONFLICT\x10\x03\x12\x1b\n" +
	"\x17ORDER_ITEM_NOT_SELLABLE\x10\x04\x12\x1c\n" +
	"\x18ORDER_STOCK_INSUFFICIENT\x10\x05\x12\x1b\n" +
	"\x17ORDER_ADDRESS_NOT_FOUND\x10\x06B/Z-github.com/tmjwjx/supermarket/api/order/v1;v1b\x06proto3"
