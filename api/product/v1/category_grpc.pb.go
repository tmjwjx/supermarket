...
const (
	CategoryService_CreateCategory_FullMethodName      = "/product.v1.CategoryService/CreateCategory"
	CategoryService_UpdateCategory_FullMethodName      = "/product.v1.CategoryService/UpdateCategory"
	CategoryService_DeleteCategory_FullMethodName      = "/product.v1.CategoryService/DeleteCategory"
	CategoryService_ListCategories_FullMethodName      = "/product.v1.CategoryService/ListCategories"
	CategoryService_AdminListCategories_FullMethodName = "/product.v1.CategoryService/AdminListCategories"
)
...
func (c *categoryServiceClient) AdminListCategories(ctx context.Context, in *AdminListCategoriesRequest, opts ...grpc.CallOption) (*AdminListCategoriesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AdminListCategoriesResponse)
	err := c.cc.Invoke(ctx, CategoryService_AdminListCategories_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCategoryServiceServer) AdminListCategories(context.Context, *AdminListCategoriesRequest) (*AdminListCategoriesResponse, error) {
...
func _CategoryService_AdminListCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AdminListCategoriesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CategoryServiceServer).AdminListCategories(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CategoryService_AdminListCategories_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).AdminListCategories(ctx, req.(*AdminListCategoriesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "product.v1.CategoryService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CategoryService_AdminListCategories_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "product/v1/category.proto",
}
