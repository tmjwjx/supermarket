...
var ProviderSet = wire.NewSet(NewData, NewDB, datastock.NewStockRepo)
...
func NewData(c *conf.Data) (*Data, func(), error) {
	...
	if c.Database.AutoMigrate {
		if err := db.AutoMigrate(&datastock.Stock{}, &datastock.StockReservation{}, &datastock.StockLog{}); err != nil {
			sqlDB.Close()
			return nil, nil, err
		}
	}
